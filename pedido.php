            ...
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        // Acción tras confirmación si es necesaria
                    }
                });
            });
        </script>";
...
<head>
    ...
    <!-- RUTAS UNIFICADAS Y SIN REPETICIONES -->
...
<body style="background-color: #f5f5f5;">
    ...
    <!-- RUTA CORREGIDA: Menú integrado en la carpeta 'includes' -->
            ...
            <div class="col-12 col-md-8 mt-5 p-5">
                ...
                <form action="codeenvio.php" method="post" class="row mt-4">
                    ...
                    <div class="col-12 mt-3">
                        <p class="small text-muted"><i class="bi bi-info-circle"></i> Asegúrate de ingresar correctamente tu email, ya que será donde recibirás los detalles de tu compra.</p>
                    </div>
                    ...
                    <div class="col-12">
                        <button class="btn btn-danger w-100" id="btnGuardar" name="save" type="submit" disabled>Ir a pagar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- RUTA CORREGIDA: Footer integrado en la carpeta 'includes' -->
