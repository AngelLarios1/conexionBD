...
// 1. VALIDACIÓN Y LÓGICA DE NEGOCIO (Siempre antes de imprimir cualquier HTML)
...
// Procesamos la alerta de sesión de manera segura para ser impresa más adelante
$alertScript = '';
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            OpenPay.setSandboxMode(false); // Cambiar a true si estás en pruebas
...
<body>
    ...
    <div class="container-fluid bg-light">
        <div class="row mt-5 justify-content-center">
            ...
            <!-- Resumen de compra (Derecha en pantallas grandes, primero en el DOM visual) -->
            <div class="col-11 col-md-4 mt-5 p-5 mb-5 order-2" style="background-color: #e7e7e7; border-radius:15px;">
                ...
                <p class="small mb-0"><?= htmlspecialchars($pedido['nombre'] . ' ' . $pedido['apellidop'] . ' ' . $pedido['apellidom'], ENT_QUOTES, 'UTF-8'); ?></p>
                ...
                <p class="small">
                    <?= htmlspecialchars($pedido['calle'], ENT_QUOTES, 'UTF-8'); ?> #<?= htmlspecialchars($pedido['exterior'], ENT_QUOTES, 'UTF-8'); ?>, 
                    <?= htmlspecialchars($pedido['colonia'], ENT_QUOTES, 'UTF-8'); ?>, <?= htmlspecialchars($pedido['ciudad'], ENT_QUOTES, 'UTF-8'); ?>, 
                    <?= htmlspecialchars($pedido['estado'], ENT_QUOTES, 'UTF-8'); ?>. CP <?= htmlspecialchars($pedido['postal'], ENT_QUOTES, 'UTF-8'); ?>
                </p>
                ...
                <div class="text-end">
                    ...
                    <?php if ($pedido['cuponMonto'] > 0): ?>
                        <p class="text-success"><b>Cupón:</b> -$<?= number_format($pedido['cuponMonto'], 2); ?></p>
                    <?php endif; ?>
                    <p><b>Envío:</b> <?= $pedido['envioMonto'] > 0 ? '$' . number_format($pedido['envioMonto'], 2) : 'GRATIS'; ?></p>
                    <p style="font-weight: 500;"><b>Total:</b> $<?= number_format($pedido['total'], 2); ?></p>
                </div>
            </div>

            <!-- Formulario de Pago (Izquierda en pantallas grandes) -->
            <div class="col-11 col-md-7 mt-5 mb-5 p-5 order-1">
                ...
                <form action="codepago.php" method="POST" id="payment-form" class="row justify-content-center">
                    ...
                    <div class="containerTarjeta row">
                        <div class="col-12 mt-3">
                            ...
                            <img src="cards1.png" alt="Tarjetas Aceptadas">
                        </div>
                        ...
                        <div class="col-12 col-md-6 mt-3">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <select id="expMonth" class="form-select" data-openpay-card="expiration_month"></select>
                                </div>
                                <div class="col-6">
                        ...
                        <div class="col-12 col-md-6 mt-3">
                            <div class="row">
                                <div class="col-12"><label>Código de seguridad</label></div>
                    ...
                    <div class="col-12 col-md-6 mt-4">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="row">
                                    <div class="col-3">
                                        <img src="security.png" alt="Seguridad">
                                    </div>
                                    <div class="col">
                ...
                <div class="p-3 mt-3 row" style="background-color: #ebbc5d78; border:2px solid #b5790066; border-radius:10px; font-size:12px;">
                    <div class="col-1">
                        <i style="background-color: #b692133b; color: #393939; padding:5px 6px; border-radius:50px;" class="bi bi-headset"></i>
                    </div>
                    <div class="col">
    ...
    <!-- Impresión de Alerta SweetAlert procesada arriba -->
    <?= $alertScript; ?>
    ...
    <script>
        ...
        const months = [
            { val: '01', text: 'Enero - 01' },
            { val: '02', text: 'Febrero - 02' },
            { val: '03', text: 'Marzo - 03' },
            { val: '04', text: 'Abril - 04' },
            { val: '05', text: 'Mayo - 05' },
            { val: '06', text: 'Junio - 06' },
            { val: '07', text: 'Julio - 07' },
            { val: '08', text: 'Agosto - 08' },
            { val: '09', text: 'Septiembre - 09' },
            { val: '10', text: 'Octubre - 10' },
            { val: '11', text: 'Noviembre - 11' },
            { val: '12', text: 'Diciembre - 12' }
        ];
