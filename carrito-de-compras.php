...
// Ajustamos $con para que use la variable que tengas en conexion.php
...
<head>
    ...
    <!-- RUTAS DE ESTILOS CORREGIDAS: Apuntando a tu carpeta css/ -->
...
<body style="background-color: #f5f5f5;">
    ...
    <!-- NUEVA RUTA CORREGIDA: Menú dentro de la carpeta includes/ -->
            ...
            <div class="col-12 col-md-6 p-4">
                ...
                <div class="mt-3">Tengo un cupón:
                    <div class="d-flex mt-1">
                        ...
                        <button style="border-radius: 0px 10px 10px 0px;" class="btn btn-secondary" id="canje">Canjear</button>
                    </div>
                </div>
    ...
    <!-- NUEVA RUTA CORREGIDA: Footer dentro de la carpeta includes/ -->
    ...
    <!-- NUEVA RUTA CORREGIDA: Script de filtros dentro de js/ -->
